...
void TSD_GFX::drawSmoothCircle(int32_t x, int32_t y, int32_t r, uint32_t fg_color, uint32_t bg_color)
{
...
void TSD_GFX::drawSpot(float ax, float ay, float r, uint32_t fg_color, uint32_t bg_color)
{
...
void TSD_GFX::drawWideLine(float ax, float ay, float bx, float by, float wd, uint32_t fg_color, uint32_t bg_color)
{
