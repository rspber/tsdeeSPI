...
public:
  ...
  void     pushImage16(clip_t& clip, int32_t x, int32_t y, int32_t w, int32_t h, uint8_t  *data, bool bpp8, cmap_t& cmap);
  void     pushImage16(clip_t& clip, int32_t x, int32_t y, int32_t w, int32_t h, uint8_t  *data, rgb_t transp, bool bpp8, cmap_t& cmap);
           // FLASH version
  void     pushImage16(clip_t& clip, int32_t x, int32_t y, int32_t w, int32_t h, const uint8_t *data, bool bpp8, cmap_t& cmap);
